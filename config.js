...
const defaultOwner = '923281262584';
...
global.pairingNumber = process.env.BOT_NUMBER || '' ;  // 923281262584
global.SESSION_ID = process.env.SESSION_ID || '' ;  // uVAHTK4B#kpFE4BURtWdoP0ugmKam18SxqiOmJJX6AFBCkoxCozk
